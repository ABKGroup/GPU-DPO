...
// void globalSwapCUDA(DetailedPlaceDB& dp_db, int num_bins_x, int num_bins_y, int batch_size, int max_iters) {
...
void globalSwapCUDA(/*DetailedPlaceDB& db,*/ int num_bins_x=512, int num_bins_y=512, int K=4, int max_iters=100) {
  ...
  // for now, everything is done on a single NVIDIA A100 (device 0)
