...
#define SWIGTYPE_p_Blif swig_types[0]
...
_wrap_create_blif__SWIG_0(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  {
    try {
      result = (Blif *)create_blif((char const *)arg1,(char const *)arg2,(char const *)arg3,(char const *)arg4,arg5); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      abort();
  ...
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_Blif,0));
  if (alloc1 == SWIG_NEWOBJ) delete[] buf1;
  if (alloc2 == SWIG_NEWOBJ) delete[] buf2;
...
_wrap_create_blif__SWIG_1(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  {
    try {
      result = (Blif *)create_blif((char const *)arg1,(char const *)arg2,(char const *)arg3,(char const *)arg4); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      abort();
...
_wrap_blif_add_instance(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Blif, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "blif_add_instance" "', argument " "1"" of type '" "Blif *""'"); 
  }
  arg1 = reinterpret_cast< Blif * >(argp1);
  res2 = SWIG_AsCharPtrAndSize(objv[2], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
...
_wrap_blif_dump(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Blif, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "blif_dump" "', argument " "1"" of type '" "Blif *""'"); 
  }
  arg1 = reinterpret_cast< Blif * >(argp1);
  res2 = SWIG_AsCharPtrAndSize(objv[2], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
...
_wrap_blif_read(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Blif, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "blif_read" "', argument " "1"" of type '" "Blif *""'"); 
  }
  arg1 = reinterpret_cast< Blif * >(argp1);
  res2 = SWIG_AsCharPtrAndSize(objv[2], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
...
static swig_type_info _swigt__p_Blif = {"_p_Blif", "Blif *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_Blif[] = {  {&_swigt__p_Blif, 0, 0, 0},{0, 0, 0, 0}};
