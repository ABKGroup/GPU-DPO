...
#define SWIG_init    Dpo_Init
#define SWIG_name    "dpo"
#define SWIG_prefix  "dpo::"
#define SWIG_namespace "dpo"
...
#endif
SWIGINTERN int
_wrap_improve_placement_cmd(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int arg2 ;
  int arg3 ;
  bool arg4 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oooo:dpo::improve_placement_cmd seed max_displacement_x max_displacement_y disallow_one_site_gaps ",(void *)0,(void *)0,(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "improve_placement_cmd" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "improve_placement_cmd" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  ecode3 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[3], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "improve_placement_cmd" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = static_cast< int >(val3);
  ecode4 = SWIG_AsVal_bool SWIG_TCL_CALL_ARGS_2(objv[4], &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "improve_placement_cmd" "', argument " "4"" of type '" "bool""'");
  } 
  arg4 = static_cast< bool >(val4);
  {
    try {
      dpo::improve_placement_cmd(arg1,arg2,arg3,arg4); 
    }
    catch (std::bad_alloc &) {
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "improve_placement_cmd", (swig_wrapper_func) _wrap_improve_placement_cmd, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Dpo_SafeInit(Tcl_Interp *interp) {
