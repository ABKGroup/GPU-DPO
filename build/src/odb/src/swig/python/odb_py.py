...
class dbBlock(object):
    ...
    def debugPrintContent(self, str_db):
        return _odb_py.dbBlock_debugPrintContent(self, str_db)
...
class dbGDSStructure(object):
    ...
    def getGDSBoundarys(self):
        return _odb_py.dbGDSStructure_getGDSBoundarys(self)
...
class dbMarkerCategory(object):
    ...
    def getMarkerCategorys(self):
        return _odb_py.dbMarkerCategory_getMarkerCategorys(self)
...
class dbModBTerm(object):
    ...
    @staticmethod
    def destroy(arg1):
        return _odb_py.dbModBTerm_destroy(arg1)
...
class dbModITerm(object):
    ...
    @staticmethod
    def destroy(arg1):
        return _odb_py.dbModITerm_destroy(arg1)
...
class dbModNet(object):
    ...
    @staticmethod
    def destroy(arg1):
        return _odb_py.dbModNet_destroy(arg1)
...
class dbModule(object):
    ...
    @staticmethod
    def copy(old_module, new_module, new_mod_inst):
        return _odb_py.dbModule_copy(old_module, new_module, new_mod_inst)

    @staticmethod
    def copyModulePorts(old_module, new_module, mod_bt_map):
        return _odb_py.dbModule_copyModulePorts(old_module, new_module, mod_bt_map)

    @staticmethod
    def copyModuleInsts(old_module, new_module, new_mod_inst, it_map):
        return _odb_py.dbModule_copyModuleInsts(old_module, new_module, new_mod_inst, it_map)

    @staticmethod
    def copyModuleModNets(old_module, new_module, mod_bt_map, it_map):
        return _odb_py.dbModule_copyModuleModNets(old_module, new_module, mod_bt_map, it_map)

    @staticmethod
    def copyModuleBoundaryIO(old_module, new_module, new_mod_inst):
        return _odb_py.dbModule_copyModuleBoundaryIO(old_module, new_module, new_mod_inst)
...
def dbModule_copy(old_module, new_module, new_mod_inst):
    return _odb_py.dbModule_copy(old_module, new_module, new_mod_inst)

def dbModule_copyModulePorts(old_module, new_module, mod_bt_map):
    return _odb_py.dbModule_copyModulePorts(old_module, new_module, mod_bt_map)

def dbModule_copyModuleInsts(old_module, new_module, new_mod_inst, it_map):
    return _odb_py.dbModule_copyModuleInsts(old_module, new_module, new_mod_inst, it_map)

def dbModule_copyModuleModNets(old_module, new_module, mod_bt_map, it_map):
    return _odb_py.dbModule_copyModuleModNets(old_module, new_module, mod_bt_map, it_map)

def dbModule_copyModuleBoundaryIO(old_module, new_module, new_mod_inst):
    return _odb_py.dbModule_copyModuleBoundaryIO(old_module, new_module, new_mod_inst)
