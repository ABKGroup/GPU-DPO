...
#line 25 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
...
#line 62 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
...
#line 49 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
namespace sta {
#line 160 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
...
#line 93 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                    { delete (yysym.value.string); }
#line 373 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
        break;
...
#line 100 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                                        {}
#line 644 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 5: // header_stmt: '(' SDFVERSION QSTRING ')'
#line 110 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                                   { delete (yystack_[1].value.string); }
#line 650 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 6: // header_stmt: '(' DESIGN QSTRING ')'
#line 111 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                               { delete (yystack_[1].value.string); }
#line 656 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 7: // header_stmt: '(' DATE QSTRING ')'
#line 112 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                             { delete (yystack_[1].value.string); }
#line 662 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 8: // header_stmt: '(' VENDOR QSTRING ')'
#line 113 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                               { delete (yystack_[1].value.string); }
#line 668 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 9: // header_stmt: '(' PROGRAM QSTRING ')'
#line 114 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                                { delete (yystack_[1].value.string); }
#line 674 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 10: // header_stmt: '(' PVERSION QSTRING ')'
#line 115 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                                 { delete (yystack_[1].value.string); }
#line 680 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 11: // header_stmt: '(' DIVIDER hchar ')'
#line 116 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                              { reader->setDivider((yystack_[1].value.character)); }
#line 686 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 12: // header_stmt: '(' VOLTAGE triple ')'
#line 117 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                               { reader->deleteTriple((yystack_[1].value.triple)); }
#line 692 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 15: // header_stmt: '(' PROCESS QSTRING ')'
#line 120 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                                { delete (yystack_[1].value.string); }
#line 698 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 18: // header_stmt: '(' TEMPERATURE triple ')'
#line 123 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                                   { reader->deleteTriple((yystack_[1].value.triple)); }
#line 704 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 20: // header_stmt: '(' TIMESCALE NUMBER ID ')'
#line 125 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                                    { reader->setTimescale((yystack_[2].value.number), (yystack_[1].value.string)); }
#line 710 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 21: // hchar: '/'
#line 130 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { (yylhs.value.character) = '/'; }
#line 716 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 22: // hchar: '.'
#line 132 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { (yylhs.value.character) = '.'; }
#line 722 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 23: // number_opt: %empty
#line 135 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
            { (yylhs.value.number_ptr) = nullptr; }
#line 728 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 24: // number_opt: NUMBER
#line 136 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                { (yylhs.value.number_ptr) = new float((yystack_[0].value.number)); }
#line 734 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 27: // cell: '(' CELL celltype cell_instance timing_specs ')'
#line 146 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { reader->cellFinish(); }
#line 740 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 28: // celltype: '(' CELLTYPE QSTRING ')'
#line 151 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { reader->setCell((yystack_[1].value.string)); }
#line 746 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 29: // cell_instance: '(' INSTANCE ')'
#line 156 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { reader->setInstance(nullptr); }
#line 752 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 30: // cell_instance: '(' INSTANCE '*' ')'
#line 158 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { reader->setInstanceWildcard(); }
#line 758 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 31: // cell_instance: '(' INSTANCE path ')'
#line 160 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { reader->setInstance((yystack_[1].value.string)); }
#line 764 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 38: // $@1: %empty
#line 179 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { reader->setInIncremental(false); }
#line 770 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 40: // $@2: %empty
#line 182 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { reader->setInIncremental(true); }
#line 776 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 44: // path: ID
#line 192 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { (yylhs.value.string) = reader->unescaped((yystack_[0].value.string)); }
#line 782 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 45: // path: path hchar ID
#line 194 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { (yylhs.value.string) = reader->makePath((yystack_[2].value.string), reader->unescaped((yystack_[0].value.string))); }
#line 788 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 46: // del_def: '(' IOPATH port_spec port_instance retains delval_list ')'
#line 199 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { reader->iopath((yystack_[4].value.port_spec), (yystack_[3].value.string), (yystack_[1].value.delval_list), nullptr, false); }
#line 794 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 47: // del_def: '(' CONDELSE '(' IOPATH port_spec port_instance retains delval_list ')' ')'
#line 202 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { reader->iopath((yystack_[5].value.port_spec), (yystack_[4].value.string), (yystack_[2].value.delval_list), nullptr, true); }
#line 800 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 48: // del_def: '(' COND EXPR_OPEN_IOPATH port_spec port_instance retains delval_list ')' ')'
#line 205 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
...
#line 806 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 49: // del_def: '(' INTERCONNECT port_instance port_instance delval_list ')'
#line 207 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { reader->interconnect((yystack_[3].value.string), (yystack_[2].value.string), (yystack_[1].value.delval_list)); }
#line 812 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 50: // del_def: '(' PORT port_instance delval_list ')'
#line 209 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { reader->port((yystack_[2].value.string), (yystack_[1].value.delval_list)); }
#line 818 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 51: // del_def: '(' DEVICE delval_list ')'
#line 211 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { reader->device((yystack_[1].value.delval_list)); }
#line 824 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 52: // del_def: '(' DEVICE port_instance delval_list ')'
#line 213 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { reader->device((yystack_[2].value.string), (yystack_[1].value.delval_list)); }
#line 830 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 55: // retain: '(' RETAIN delval_list ')'
#line 223 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { reader->deleteTripleSeq((yystack_[1].value.delval_list)); }
#line 836 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 56: // delval_list: value
#line 228 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { (yylhs.value.delval_list) = reader->makeTripleSeq(); (yylhs.value.delval_list)->push_back((yystack_[0].value.triple)); }
#line 842 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 57: // delval_list: delval_list value
#line 230 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { (yystack_[1].value.delval_list)->push_back((yystack_[0].value.triple)); (yylhs.value.delval_list) = (yystack_[1].value.delval_list); }
#line 848 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 60: // $@3: %empty
#line 238 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                  { reader->setInTimingCheck(true); }
#line 854 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 61: // tchk_def: '(' SETUP $@3 port_tchk port_tchk value ')'
#line 240 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
...
#line 862 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 62: // $@4: %empty
#line 243 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                 { reader->setInTimingCheck(true); }
#line 868 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 63: // tchk_def: '(' HOLD $@4 port_tchk port_tchk value ')'
#line 245 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { reader->timingCheck(sta::TimingRole::hold(), (yystack_[3].value.port_spec), (yystack_[2].value.port_spec), (yystack_[1].value.triple));
	  reader->setInTimingCheck(false);
	}
#line 876 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 64: // $@5: %empty
#line 248 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                      { reader->setInTimingCheck(true); }
#line 882 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 65: // tchk_def: '(' SETUPHOLD $@5 port_tchk port_tchk value value ')'
#line 250 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
...
#line 890 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 66: // $@6: %empty
#line 253 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                     { reader->setInTimingCheck(true); }
#line 896 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 67: // tchk_def: '(' RECOVERY $@6 port_tchk port_tchk value ')'
#line 255 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { reader->timingCheck(sta::TimingRole::recovery(),(yystack_[3].value.port_spec),(yystack_[2].value.port_spec),(yystack_[1].value.triple));
	  reader->setInTimingCheck(false);
	}
#line 904 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 68: // $@7: %empty
#line 258 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                    { reader->setInTimingCheck(true); }
#line 910 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 69: // tchk_def: '(' REMOVAL $@7 port_tchk port_tchk value ')'
#line 260 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { reader->timingCheck(sta::TimingRole::removal(),(yystack_[3].value.port_spec),(yystack_[2].value.port_spec),(yystack_[1].value.triple));
	  reader->setInTimingCheck(false);
	}
#line 918 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 70: // $@8: %empty
#line 263 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                   { reader->setInTimingCheck(true); }
#line 924 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 71: // tchk_def: '(' RECREM $@8 port_tchk port_tchk value value ')'
#line 265 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
...
#line 932 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 72: // $@9: %empty
#line 268 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                 { reader->setInTimingCheck(true); }
#line 938 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 73: // tchk_def: '(' SKEW $@9 port_tchk port_tchk value ')'
#line 271 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { reader->timingCheck(sta::TimingRole::skew(),(yystack_[2].value.port_spec),(yystack_[3].value.port_spec),(yystack_[1].value.triple));
	  reader->setInTimingCheck(false);
	}
#line 946 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 74: // $@10: %empty
#line 274 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                  { reader->setInTimingCheck(true); }
#line 952 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 75: // tchk_def: '(' WIDTH $@10 port_tchk value ')'
#line 276 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { reader->timingCheckWidth((yystack_[2].value.port_spec), (yystack_[1].value.triple));
	  reader->setInTimingCheck(false);
	}
#line 960 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 76: // $@11: %empty
#line 279 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                   { reader->setInTimingCheck(true); }
#line 966 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 77: // tchk_def: '(' PERIOD $@11 port_tchk value ')'
#line 281 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { reader->timingCheckPeriod((yystack_[2].value.port_spec), (yystack_[1].value.triple));
	  reader->setInTimingCheck(false);
	}
#line 974 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 78: // $@12: %empty
#line 284 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                     { reader->setInTimingCheck(true); }
#line 980 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 79: // tchk_def: '(' NOCHANGE $@12 port_tchk port_tchk value value ')'
#line 286 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
...
#line 988 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 80: // port: ID
#line 293 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { (yylhs.value.string) = reader->unescaped((yystack_[0].value.string)); }
#line 994 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 81: // port: ID '[' DNUMBER ']'
#line 295 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { (yylhs.value.string) = reader->makeBusName((yystack_[3].value.string), (yystack_[1].value.integer)); }
#line 1000 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 82: // port_instance: port
#line 299 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { (yylhs.value.string) = (yystack_[0].value.string); }
#line 1006 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 83: // port_instance: path hchar port
#line 301 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { (yylhs.value.string) = reader->makePath((yystack_[2].value.string), (yystack_[0].value.string)); }
#line 1012 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 84: // port_spec: port_instance
#line 306 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { (yylhs.value.port_spec)=reader->makePortSpec(sta::Transition::riseFall(),(yystack_[0].value.string),nullptr); }
#line 1018 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 85: // port_spec: '(' port_transition port_instance ')'
#line 308 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { (yylhs.value.port_spec) = reader->makePortSpec((yystack_[2].value.transition), (yystack_[1].value.string), nullptr); }
#line 1024 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 86: // port_transition: POSEDGE
#line 312 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                { (yylhs.value.transition) = sta::Transition::rise(); }
#line 1030 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 87: // port_transition: NEGEDGE
#line 313 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                { (yylhs.value.transition) = sta::Transition::fall(); }
#line 1036 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 88: // port_tchk: port_spec
#line 317 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { (yylhs.value.port_spec) = (yystack_[0].value.port_spec); }
#line 1042 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 89: // port_tchk: '(' COND EXPR_ID_CLOSE
#line 319 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { (yylhs.value.port_spec) = reader->makeCondPortSpec((yystack_[0].value.string)); }
#line 1048 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 90: // port_tchk: '(' COND EXPR_OPEN port_transition port_instance ')' ')'
#line 321 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { (yylhs.value.port_spec) = reader->makePortSpec((yystack_[3].value.transition), (yystack_[2].value.string), (yystack_[4].value.string)); }
#line 1054 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 91: // value: '(' ')'
#line 326 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        {
	  (yylhs.value.triple) = reader->makeTriple();
	}
#line 1062 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 92: // value: '(' NUMBER ')'
#line 330 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        {
	  (yylhs.value.triple) = reader->makeTriple((yystack_[1].value.number));
	}
#line 1070 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 93: // value: '(' triple ')'
#line 333 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
                       { (yylhs.value.triple) = (yystack_[1].value.triple); }
#line 1076 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 94: // triple: NUMBER ':' number_opt ':' number_opt
#line 338 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        {
...
#line 1085 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 95: // triple: number_opt ':' NUMBER ':' number_opt
#line 343 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        {
...
#line 1094 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 96: // triple: number_opt ':' number_opt ':' NUMBER
#line 348 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        {
...
#line 1103 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 97: // NUMBER: FNUMBER
#line 355 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { (yylhs.value.number) = (yystack_[0].value.number); }
#line 1109 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 98: // NUMBER: DNUMBER
#line 357 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { (yylhs.value.number) = static_cast<float>((yystack_[0].value.integer)); }
#line 1115 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;

  case 99: // NUMBER: '-' DNUMBER
#line 359 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
        { (yylhs.value.number) = static_cast<float>(-(yystack_[0].value.integer)); }
#line 1121 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
    break;


#line 1125 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"
...
#line 1655 "/home/jsliang/GPU-DPO/build/src/sta/SdfParse.cc"

#line 362 "/home/jsliang/GPU-DPO/src/sta/sdf/SdfParse.yy"
