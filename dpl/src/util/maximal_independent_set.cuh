...
__device__ void mark_dependent_nodes_self(const GpuData& db,
...
__global__ void maximal_independent_set_kernel(GpuData db,
                                               IndependentSetMatchingState state,
                                               int* empty) {
...
__global__ void mark_dependent_nodes_kernel(GpuData db, IndependentSetMatchingState state) {
...
__global__ void init_markers_kernel(GpuData db, IndependentSetMatchingState state) {
...
void maximal_independent_set(const GpuData& db, IndependentSetMatchingState& state) {
